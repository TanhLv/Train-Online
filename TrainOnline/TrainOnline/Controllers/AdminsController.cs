...
namespace TrainOnline.Controllers
{
	...
	public class AdminsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AdminId,Name,Age,Gender,PhoneNumber,Email,Password,Address")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdminId,Name,Age,Gender,PhoneNumber,Email,Password,Address")] Admin admin)
        {
            if (id != admin.AdminId)
            {
                return NotFound();
